...
| [0033](0033-native-dataframe-engine.md) | A native DataFrame engine — replace polars, staged, with polars as the oracle | **Accepted — Stage 0 implemented** (frozen frame format in framefmt.rs, seam minus collect_string); Stage 1 NativeFrame next; flip conditions recorded |
