...
pub static BUILTINS: &[BuiltinDef] = &[
    ...
    BuiltinDef { path: "bio.read_bcf", pure: false },
    BuiltinDef { path: "bio.read_sam", pure: false },
    BuiltinDef { path: "bio.read_bam", pure: false },
...
pub static DNA_METHODS: &[&str] = &[
    "gc_content", "reverse_complement", "complement", "kmers", "windows", "kmer_counts", "find",
    "length",
];
