...
#[inline]
pub(super) fn a_dna(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_read_vcf(args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_read_bcf(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_read_sam(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_read_bam(args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_read_gff(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_read_bed(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_read_fasta(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_read_fastq(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
...
#[inline]
pub(super) fn a_align(args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
