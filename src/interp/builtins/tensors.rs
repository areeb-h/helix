...
#[inline]
pub(super) fn a_to_tensor(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
...
#[inline]
pub(super) fn a_tensor(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
...
#[inline]
pub(super) fn a_zeros(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
...
#[inline]
pub(super) fn a_eye(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
...
#[inline]
pub(super) fn a_argmax(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
...
#[inline]
pub(super) fn a_linspace(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
