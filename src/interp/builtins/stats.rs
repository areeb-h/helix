...
#[inline]
pub(super) fn a_correlation(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_t_test(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
...
#[inline]
pub(super) fn a_linear_regression(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
...
#[inline]
pub(super) fn a_multiple_regression(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_least_squares(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_mse(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
...
#[inline]
pub(super) fn a_aic(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_accuracy(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
...
#[inline]
pub(super) fn a_precision(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        if args.len() != 2 && args.len() != 3 {
            return Err(HelixError::new(
...
#[inline]
pub(super) fn a_confusion_matrix(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        if args.len() != 2 && args.len() != 3 {
            return Err(HelixError::new(
