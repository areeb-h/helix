...
#[inline]
pub(super) fn a_sha256(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_hmac_sha256(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_url_decode(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
            Value::Str(s) => {
...
#[inline]
pub(super) fn a_url_decode_lenient(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
            Value::Str(s) => {
...
#[inline]
pub(super) fn a_base64_encode(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
            Value::Str(s) => {
...
#[inline]
pub(super) fn a_base64_decode(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
            Value::Str(s) => {
...
#[inline]
pub(super) fn a_hex_encode(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
...
#[inline]
pub(super) fn a_hex_decode(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 1, line, col)?;
        match &args[0] {
            Value::Missing => Ok(Value::Missing),
...
#[inline]
pub(super) fn a_aes_keygen(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
...
#[inline]
pub(super) fn a_aes_encrypt(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
        if matches!(args[0], Value::Missing) || matches!(args[1], Value::Missing) {
            return Ok(Value::Missing);
        }
...
#[inline]
pub(super) fn a_aes_decrypt(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
        if matches!(args[0], Value::Missing) || matches!(args[1], Value::Missing) {
            return Ok(Value::Missing);
        }
...
#[inline]
pub(super) fn a_ed25519_keygen(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 0, line, col)?;
...
#[inline]
pub(super) fn a_ed25519_sign(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
        arity(name, &args, 2, line, col)?;
        if matches!(args[0], Value::Missing) || matches!(args[1], Value::Missing) {
            return Ok(Value::Missing);
        }
...
#[inline]
pub(super) fn a_ed25519_verify(name: &str, args: Vec<Value>, line: usize, col: usize) -> Result<Value, HelixError> {
